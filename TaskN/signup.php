			...
			<div id="content">
				...
				<form action="register.php" method="POST">
					<div class="form-group">
						...
						<input class="form-control" type="text" name="regname" id="username" placeholder="Username" required />
					</div>
					<div class="form-group">
						<label for="email">Email</label>
						<input class="form-control" type="text" name="regemail" id="email" placeholder="Email" required />
					</div>
					<div class="form-group">
						<label for="password">Password</label>
						<input class="form-control" type="password" name="regpsw" id="password" placeholder="Password" required />
					</div>
					<div class="m-t-lg">
						<ul class="list-inline">
							...
							<li>
								<a class="signup__link" href="userlogin.php">I am already a member</a>
							</li>
						</ul>
					</div>
				</form>
